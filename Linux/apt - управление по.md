...
Если рассматривать разница между apt и apt-get, то на самом деле она только в том, что apt включает в себя apt-get и тд и выводит все в реально времени графически.